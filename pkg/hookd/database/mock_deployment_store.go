...
type mockConstructorTestingTNewMockDeploymentStore interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockDeploymentStore(t mockConstructorTestingTNewMockDeploymentStore) *MockDeploymentStore {
