...
func (h *AzureApiKeyHandler) GetApiKeys(w http.ResponseWriter, r *http.Request) {
...
func (h *AzureApiKeyHandler) GetTeamApiKey(w http.ResponseWriter, r *http.Request) {
	fields := middleware.RequestLogFields(r)
	logger := log.WithFields(fields)
...
func (h *AzureApiKeyHandler) RotateTeamApiKey(w http.ResponseWriter, r *http.Request) {
	fields := middleware.RequestLogFields(r)
	logger := log.WithFields(fields)
