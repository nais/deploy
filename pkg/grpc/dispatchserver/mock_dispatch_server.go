...
func (_m *MockDispatchServer) Deployments(_a0 *pb.GetDeploymentOpts, _a1 grpc.ServerStreamingServer[pb.DeploymentRequest]) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*pb.GetDeploymentOpts, grpc.ServerStreamingServer[pb.DeploymentRequest]) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
