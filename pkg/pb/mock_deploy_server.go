...
func (_m *MockDeployServer) Status(_a0 *DeploymentRequest, _a1 grpc.ServerStreamingServer[DeploymentStatus]) error {
	ret := _m.Called(_a0, _a1)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*DeploymentRequest, grpc.ServerStreamingServer[DeploymentStatus]) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
