...
func (_m *MockDispatchClient) Deployments(ctx context.Context, in *GetDeploymentOpts, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DeploymentRequest], error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *GetDeploymentOpts, ...grpc.CallOption) (grpc.ServerStreamingClient[DeploymentRequest], error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *GetDeploymentOpts, ...grpc.CallOption) grpc.ServerStreamingClient[DeploymentRequest]); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
