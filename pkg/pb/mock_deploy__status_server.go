...
type mockConstructorTestingTNewMockDeploy_StatusServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockDeploy_StatusServer(t mockConstructorTestingTNewMockDeploy_StatusServer) *MockDeploy_StatusServer {
