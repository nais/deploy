...
type mockConstructorTestingTNewMockDispatch_DeploymentsServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockDispatch_DeploymentsServer(t mockConstructorTestingTNewMockDispatch_DeploymentsServer) *MockDispatch_DeploymentsServer {
