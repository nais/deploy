...
type mockConstructorTestingTNewMockDispatch_DeploymentsClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockDispatch_DeploymentsClient(t mockConstructorTestingTNewMockDispatch_DeploymentsClient) *MockDispatch_DeploymentsClient {
